package com.raven.file.fdfs.service.impl;
...
import com.raven.file.fdfs.bean.OutputFileInfo;
import com.raven.file.fdfs.bean.OutputFileMetaInfo;
...
public class FastDFSFileServiceImpl implements FastDFSFileService {
    ...
    public Result uploadFile(MultipartFile file) {
        ...
        metaSet.add(
            new MetaData(META_FILE_EXT, FilenameUtils.getExtension(file.getOriginalFilename())));
        try {
    ...
    public Result deleteFile(String fileUrl) {
        try {
            ...
            log.info(
                "groupName:" + storePath.getGroup() + "------" + " path：" + storePath.getPath());
