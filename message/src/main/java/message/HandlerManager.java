...
import message.handler.GreetHandler;
...
public class HandlerManager {
    ...
    private static final Map<Integer, Constructor<? extends message.IMHandler>> _handlers = new HashMap<>();

    public static void register(Class<? extends Message> msg, Class<? extends message.IMHandler> handler) {
        int num = ParseMap.getPtoNum(msg);
        try {
            Constructor<? extends message.IMHandler> constructor = handler.getConstructor(String.class, long.class, Message.class, ChannelHandlerContext.class);
    ...
    public static IMHandler getHandler(int msgNum, String userId, long netId,
        ...
        Constructor<? extends message.IMHandler> constructor = _handlers.get(msgNum);
        if(constructor == null) {
