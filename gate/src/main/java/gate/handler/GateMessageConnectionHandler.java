 ...
 */
public class GateMessageConnectionHandler extends SimpleChannelInboundHandler<Message> {

    private static final Logger logger = LoggerFactory.getLogger(GateMessageConnectionHandler.class);
